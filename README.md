...
6、中间件
例如[异步MySQL组件](components/react-mysql.md)，[异步redis组件](components/react-redis.md)，[异步http组件](components/react-http-client.md)，[异步消息队列组件](components/react-zmq.md)，[异步dns组件](components/react-dns.md)，[文件监控组件](components/file-monitor.md)，还有很多第三方开发的组件框架等等
