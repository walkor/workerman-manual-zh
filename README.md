...
6、中间件  
例如 [异步MySQL组件](/components/react-mysql.html)，[异步redis组件](/components/react-redis.html)，[异步http组件](/components/react-redis.html)，[异步消息队列组件](/components/react-http-client.html)，[异步dns组件](/components/react-dns.html)，[文件监控组件](/components/file-monitor.html)，还有很多第三方开发的组件框架等等
